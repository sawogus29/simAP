...
extern void fmt_scan_entry(struct scan_entry *cur);
/* GLOBAL VARIABLES */
struct nl_sock *scan_wait_sk;
...
/* Order by frequency. */
bool cmp_freq(const struct scan_entry *a, const struct scan_entry *b)
{
	return a->freq < b->freq;
}

/* Order by signal strength. */
bool cmp_sig(const struct scan_entry *a, const struct scan_entry *b)
{
...
bool cmp_essid(const struct scan_entry *a, const struct scan_entry *b)
{
...
int wait_event(struct nl_msg *msg, void *arg)
{
 ...
 */
bool wait_for_scan_events(void)
{
...
int iw_nl80211_scan_trigger(void)
{
...
int iw_nl80211_get_scan_data(struct scan_result *sr)
{
 ...
 */
void compute_channel_stats(struct scan_result *sr)
{
